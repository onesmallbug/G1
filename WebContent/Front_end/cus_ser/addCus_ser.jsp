...
<TABLE>
		...
		<td>會員編號:</td>
		<td>
		<input type="TEXT" name="member_no" value="<%= (cus_serVO==null)? "" : cus_serVO.getMember_no()%>">
		</td>
	</tr>
	...
	<tr>
		...
		<%--  <td><input  name="customer_service_start_date"  id="f_date1" type="DATE" value="<%= (cus_serVO==null)? "" : cus_serVO.getCustomer_service_start_date()%>"></td>		 --%>
	</tr>
