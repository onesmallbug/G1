	...
	<!-- 工作區開始 -->
		...
		<div class="container">
			<div class="row justify-content">
				...
				<tr><th>${s.count}</th><th><a href="<%=request.getContextPath()%>/Front_end/movieinfo/rankMovieListOne.jsp?movie_no=${movieInfoVO.movie_no}">${movieInfoVO.movie_name}</a></th><th>${movieGenreService.getOneGenre(movieInfoVO.genre_no).genre_name}</th><th>${movieInfoVO.movie_score}</th></tr>
				</c:forEach>
				</table>
				</div>
				</div>
