...
<%
	TicketorderVO ticketorderVO = (TicketorderVO) request.getAttribute("ticketorderVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<title>資料修改 - update_ticketorder_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>員工資料修改 - update_ticketorder_input.jsp</h3>
