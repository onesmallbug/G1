...
<ul>
  ...
  <li><a href='listAllTicketorder.jsp'>List</a> all Ticketorder.  <br><br></li>
     ...
     <FORM METHOD="post" ACTION="ticketorder.do" >
       ...
       <select size="1" name="order_no">
         <c:forEach var="ticketorderVO" items="${ticketorderSvc.all}" > 
          <option value="${ticketorderVO.order_no}">${ticketorderVO.order_no}
         </c:forEach>   
       </select>
