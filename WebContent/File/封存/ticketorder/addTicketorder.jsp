...
<title>資料新增 - addTicketorder.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>資料新增 - addTicketorder.jsp</h3></td><td>
		 <h4><a href="select_page_ticketorder.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="member_no" size="45" 
			 value="<%= (ticketorderVO==null)? "10020" : ticketorderVO.getMember_no()%>" /></td>
	</tr>
	<tr>
		<td>優惠編號:</td>
		<td><input type="TEXT" name="fd_no" size="45" 
			 value="<%= (ticketorderVO==null)? "20" : ticketorderVO.getFd_no()%>" /></td>
	</tr>
	<tr>
		<td>場次編號:</td>
		<td><input type="TEXT" name="session_no" size="45" 
			 value="<%= (ticketorderVO==null)? "120" : ticketorderVO.getSession_no()%>" /></td>
	</tr>
	<tr>
		<td>員工編號:</td>
		<td><input type="TEXT" name="employee_no" size="45" 
			 value="<%= (ticketorderVO==null)? "0020" : ticketorderVO.getEmployee_no()%>" /></td>
	</tr>
	<tr>
		<td>揪團訂單:</td>
		<td><input type="TEXT" name="order_group" size="45"
			 value="<%= (ticketorderVO==null)? "0" : ticketorderVO.getOrder_group()%>" /></td>
	</tr>
	<tr>
		<td>是否取餐:</td>
		<td><input type="TEXT" name="order_takemeals" size="45"
			 value="<%= (ticketorderVO==null)? "0" : ticketorderVO.getOrder_takemeals()%>" /></td>
	</tr>
	<tr>
		<td>訂單時間:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="order_amount" size="45"
			 value="<%= (ticketorderVO==null)? "20" : ticketorderVO.getOrder_amount()%>" /></td>
	</tr>
...
<% 
  ...
  try {
	  order_time = ticketorderVO.getOrder_time();
   } catch (Exception e) {
