...
<!-- =================================================================================================================== -->
								var select_page  = path + "/Back_end/sessions/select_date_Basic.jsp";
								var select_page2 = path+"/Back_end/sessions/insertSessions.jsp";
								...
								cell.html("<div class='parent'>"
	                           		 ...
	                           		 + " width=95% height=70% scrolling=no></iframe>"
	                           		 + "<div class='link' style='height: 20px'>"
	                           		 + "<a href=\'" +select_page2+ "?theDate=" + theDate + "\'>"
