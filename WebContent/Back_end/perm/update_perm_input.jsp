...
<table>
	...
	<tr>
		<td>權限名稱:</td>
		<td><input type = "TEXT" name="permission_name" value="<%= (permVO==null)? "":permVO.getPermission_name()%>" /></td>
	</tr>

</table>
<br>
<input type = "hidden" name="action" value="update">
<input type = "hidden" name="permission_no" value="<%=permVO.getPermission_no()%>">
